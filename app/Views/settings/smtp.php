<!-- =====================================================================
     ...
     Muestra el título de ajustes SMTP y la ruta de navegación.
     ===================================================================== -->
    ...
    <!-- =====================================================================
         ...
         Campos para configurar el servidor de correo, credenciales y cifrado.
         ===================================================================== -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('settings/smtp/update') ?>" method="POST">
                        ...
                        <div class="d-flex justify-content-center gap-2 mt-4">
                            ...
                            <button type="submit" formaction="<?= base_url('settings/smtp/test') ?>" formmethod="POST" class="btn btn-warning text-white px-4 me-2">Probar</button>
